...
<head>
  <meta charset="utf-8">
	<title>¡Concientizate ambiente!</title>
	<link rel="icon" href="img/icono.jpeg" sizes="10x10" type="image/jpeg">
	<link rel="stylesheet" type="text/css" href="cssUsuario/estilo.css">
</head>
<body>
...
<br>
<input type="text" placeholder="Correo_electronico" value="<?php echo $correo;?>" disabled/>
<br>
<input type="text" placeholder="Contraseña" value="<?php echo $password;?>"disabled/>
<br>
<input type="text" placeholder="Nombres" value="<?php echo $nombre;?>" disabled/>
<br>
<input type="text" placeholder="Apellidos" value="<?php echo $apellido;?>" disabled/>
<br>
<input type="text" placeholder="Documento" value="<?php echo $documento;?>" disabled/>
<br>

<button><a href="home.php">
Regresar</a></button>
<button><a href="formulario.php">
